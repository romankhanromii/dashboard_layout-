...
//       <div className="w-[503px] min-h-fit py-6 px-8 bg-white rounded-lg shadow-md shadow-black/10">
...
//             <span className="text-sm text-blue-800 cursor-pointer">
//               Forgot Password?
//             </span>
//           </div>
//           <button
...
//             <p className="text-sm text-gray-600">New to EcoSnap?</p>
//             <Link to="/signup" className="text-sm text-blue-800 cursor-pointer">
//               Create Account
//             </Link>
//           </div>
//         </form>
